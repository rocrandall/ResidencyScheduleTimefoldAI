= Residency Scheduling - Modified from Employee Scheduling (Java, Quarkus, Maven)
...
[source, shell]
----
$ docker run -p 8080:8080 timefold-solver-quarkus-employee-scheduling-quickstart:1.0-SNAPSHOT
----
